    ...
    public partial class New4 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2018, 12, 17, 21, 56, 28, 323, DateTimeKind.Local), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "This is IQ quiz ", "iq_01", true, 20f, "IQ Quiz 01" },
                    { 2, new DateTime(2018, 12, 17, 21, 56, 28, 323, DateTimeKind.Local), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "This is java quiz", "java_01", true, 20f, "Java Quiz 01" },
                    { 3, new DateTime(2018, 12, 17, 21, 56, 28, 323, DateTimeKind.Local), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "This is .Net quiz", "net_01", true, 20f, "NET Quiz 01" },
                    { 4, new DateTime(2018, 12, 17, 21, 56, 28, 323, DateTimeKind.Local), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "This is english quiz", "english_01", true, 20f, "English Quiz 01" },
                    { 5, new DateTime(2018, 12, 17, 21, 56, 28, 323, DateTimeKind.Local), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "This is english Gmat", "gmat_01", true, 10f, "Gmat Quiz 01" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2018, 12, 17, 21, 56, 28, 321, DateTimeKind.Local), "emp1@email.com", null, "emp1", "123", 1 },
                    { 2, new DateTime(2018, 12, 17, 21, 56, 28, 323, DateTimeKind.Local), "emp2@email.com", null, "emp2", "123", 1 }
                });
